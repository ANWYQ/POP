...
(function() {
    ...
    const config = {
        baseDelay: () => Math.random() * 200 + 100,
        voteDelay: () => Math.random() * 2300 + 2000,
        fieldDelay: () => Math.random() * 20 + 10,
        checkInterval: 500,
        timeout: 90000
    };
    ...
    const categories = {
        ...
        sapphicStar: {
            ...
            option: '//section[@data-award-id="3"]//label[2]'
        }
    };
